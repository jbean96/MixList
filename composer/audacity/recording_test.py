...
def playRecord( name ) :
    do("Import: Filename='/home/jwcruz/481/MixList/testmp3s/" + name + ".mp3'")
    do("Select: Track=0")
...
def exportIt( name ):
    do("Select: Track=1")
    do("SelectTrackStartToEnd")
    do("Export: Filename='/home/jwcruz/Desktop/recordingtest" + name + ".wav' Mode=Selection Channels=1.0")
    do("Select: Track=0")
    do("SelectTrackStartToEnd")
